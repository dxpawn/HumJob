...
server-side. Everything runs locally; no audio is sent to any third-party
service.
...
The web application is tabbed, and three tabs are separate paths that do not go
